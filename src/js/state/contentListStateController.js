...
app.controller('contentListStateController', function ($rootScope, $state, $scope, $location, $$log, $$title, $$navbar, $$tabbar, getData, $stateParams, $$txIM, $$toast, $http, $$requestUrl, $$iconfont, $$color, $$loading, $timeout) {
