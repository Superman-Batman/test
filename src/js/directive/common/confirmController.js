        ...
        controller: function ($rootScope, $timeout, $sce, $scope, $$log) {
            ...
            $rootScope.$on('confirmShow', function (e, option) {
                ...
                if (option.title && option.msg && option.callback) {
                    ...
                    $scope.hideCancel = option.hideCancel && (option.hideCancel == true);
                    $scope.hideConfirm = option.hideConfirm && (option.hideConfirm == true);
                    $scope.cancelBgColor = option.cancelBgColor == true;
                    // $scope.$apply();
                } else {
