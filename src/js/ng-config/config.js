...
app.config(['$stateProvider', '$urlMatcherFactoryProvider', '$urlRouterProvider', '$httpProvider', '$locationProvider', '$sceProvider', function ($stateProvider, $urlMatcherFactoryProvider, $urlRouterProvider, $httpProvider, $locationProvider, $sceProvider) {
    ...
    $stateProvider.state("inputConfirmDemo", {
        ...
        resolve: {
            getData: function ($http, $stateParams, $$log, $$requestUrl) {
                if (($stateParams.weekOffset == undefined || $stateParams.weekOffset == 0) && localStorage['changeSchedulePersonStateController'] && (+(new Date()) - (+(JSON.parse(localStorage['changeSchedulePersonStateController']).time))) < -1 * 60 * 1000) {
        ...
        resolve: {
            getData: function ($http, $stateParams, $$log, $$requestUrl) {
                if (($stateParams.weekOffset == undefined || $stateParams.weekOffset == 0) && localStorage['changeScheduleClassStateController'] && (+(new Date()) - (+(JSON.parse(localStorage['changeScheduleClassStateController']).time))) < -1 * 60 * 1000) {
        ...
        resolve: {
            getData: function ($http, $stateParams, $$log, $$requestUrl) {
                if (($stateParams.weekOffset == undefined || $stateParams.weekOffset == 0) && localStorage['batchSchedulesStateController'] && (+(new Date()) - (+(JSON.parse(localStorage['batchSchedulesStateController']).time))) < -1 * 60 * 1000) {
        ...
        controller: "createAnnouncementStateController",
        templateUrl: "templates/state/createAnnouncementState.html"
    }).state('editAnnouncementState', {
        //编辑科室公告
        url: "/editAnnouncement/:eventId",
        controller: "editAnnouncementStateController",
        templateUrl: "templates/state/editAnnouncementState.html",
        resolve: {
            getData: function ($http, $stateParams, $$log, $$requestUrl, $state) {
                return $http({
                    method: 'GET',
                    url: $$requestUrl.getUrl("updateAnnouncement", {id: $stateParams.eventId}),
                    params: {}
                }).success(function (response) {
                    $$log.debug('updateAnnouncement');
                    $$log.info(response);
                    return response;
                });
            }
        ...
        templateUrl: "templates/state/messageListState.html",
        resolve: {
            getData: function ($http, $stateParams, $$log, $$requestUrl) {
                if (localStorage['messageListState'] && (+(new Date()) - (+(JSON.parse(localStorage['messageListState']).time))) < -1 * 60 * 1000) {
                    return {data: JSON.parse(localStorage['messageListState']).date};
                } else {
                    return $http({
                        method: 'GET',
                        url: $$requestUrl.getUrl("recentCalenderStateController"),
                        params: {
                            scenario: 'messageCenter'
                        }
                    }).success(function (response) {
        ...
        //科室公告公告板
        url: "/messageContent/:eventId",
        controller: "messageContentStateController",
        templateUrl: "templates/state/messageContentState.html",
        resolve: {
            getData: function ($http, $stateParams, $$log, $$requestUrl, $state) {
                return $http({
                    method: 'GET',
                    url: $$requestUrl.getUrl("messageContent", {id: $stateParams.eventId}),
                    params: {}
                }).success(function (response) {
        ...
        resolve: {
            getData: function ($http, $stateParams, $$log, $$requestUrl) {
                if (localStorage['allPatientList'] && (+(new Date()) - (+(JSON.parse(localStorage['allPatientList']).time))) < -1 * 60 * 1000) {
        ...
        resolve: {
            getData: function ($http, $stateParams, $$log, $$requestUrl, $$toast) {
                if (localStorage['nurseList'] && (+(new Date()) - (+(JSON.parse(localStorage['nurseList']).time))) < -1 * 60 * 1000) {
        ...
        resolve: {
            getData: function ($http, $stateParams, $$log, $$requestUrl, $$toast) {
                return $http({
                    method: 'GET',
                    url: $$requestUrl.getUrl("chooseToolPage"),
                    params: {}
                }).success(function (response) {
                   if (response.result.success != true) {
                       $$toast.show(response.result.displaymsg);
                   }
                   $$log.debug("chooseToolPage");
                   $$log.info(response);
                   return response;
                });
            }
        ...
        resolve: {
            getData: function ($http, $stateParams, $$log, $$requestUrl, $$toast) {
                if (localStorage['contentListStateController'] && (+(new Date()) - (+(JSON.parse(localStorage['contentListStateController']).time))) < -1 * 60 * 1000) {
        ...
        resolve: {
            getData: function ($http, $stateParams, $$log, $$requestUrl, $q) {
                if (localStorage['selectList'] && (+(new Date()) - (+(JSON.parse(localStorage['selectList']).time))) < -1 * 60 * 1000) {
    ...
    //---------yih
        .state('messageTag', {
            ...
            resolve: {
                ...
                getVersion: function ($http, $stateParams, $$log, $$requestUrl) {
                    if (localStorage['getVersion'] && (+(new Date()) - (+(JSON.parse(localStorage['getVersion']).time))) < -1 * 60 * 1000) {
                        return {data: JSON.parse(localStorage['getVersion']).date};
                    } else {
                        return $http({
                            method: 'GET',
                            url: $$requestUrl.getUrl("getVersion"),
                            params: {}
                        }).success(function (response) {
                            ...
                            if (response.result.success == true) {
                                ...
                                localStorage['getVersion'] = JSON.stringify(ls);
                            }
                            return response;
                        });
                    }
        ...
        .state('recentCalender', {
            ...
            resolve: {
                getData: function ($http, $stateParams, $$log, $$requestUrl) {
                    if (localStorage['recentCalenderState'] && (+(new Date()) - (+(JSON.parse(localStorage['recentCalenderState']).time))) < -1 * 60 * 1000) {
                        return {data: JSON.parse(localStorage['recentCalenderState']).date};
                    } else {
                        return $http({
                            method: 'GET',
                            url: $$requestUrl.getUrl("recentCalenderStateController"),
        ...
        .state('hefeiOrderList', {
           //订单列表
            url: "/hefeiOrderList",
            controller: "hefeiOrderListStateController",
            templateUrl: "templates/state/hefeiOrderListState.html",
            resolve: {
                getData: function ($http, $stateParams, $$log, $$requestUrl, $$toast) {
                    return $http({
                        method: 'GET',
                        ...
                        $$log.debug('hefeiOrderListStateController');
                        $$log.info(response);
                        return response;
                    });
                }
        ...
        .state('hefeiOrderDetail', {
            //订单详情
            url: "/:orderId/hefeiOrderDetail/:patientId",
            controller: "hefeiOrderDetailStateController",
            templateUrl: "templates/state/hefeiOrderDetailState.html",
            resolve: {
                getData: function ($http, $stateParams, $$log, $$requestUrl, $$toast) {
                    return $http({
                        method: 'GET',
                        url: $$requestUrl.getUrl("hefeiOrderDetailStateController", {"orderId": $stateParams.orderId, "patientId": $stateParams.patientId}),
                        params: {
                        ...
                        $$log.debug('hefeiOrderDetailStateController');
                        $$log.info(response);
                        return response;
                    });
                }
        ...
        .state('hefeiServiceSelect', {
            //可服务项目
            url: "/:nurseId/hefeiServiceSelect",
            controller: "hefeiServiceSelectStateController",
            templateUrl: "templates/state/hefeiServiceSelectState.html",
            resolve: {
                getData: function ($http, $stateParams, $$log, $$requestUrl, $$toast) {
                    return $http({
                        method: 'GET',
                        url: $$requestUrl.getUrl("hefeiServiceConfigStateController", { "nurseId": localStorage.globalNurseId}),
                        params: {
                        }
                    }).success(function (response) {
                        if (response.result.success != true) {
                        ...
                        $$log.debug('hefeiServiceConfigStateController');
                        $$log.info(response);
                        return response;
                    });
                }
        ...
        .state('hefeiServiceConfig', {
            //项目管理
            url: "/:nurseId/hefeiServiceConfig",
            controller: "hefeiServiceConfigStateController",
            templateUrl: "templates/state/hefeiServiceConfigState.html",
            resolve: {
                getData: function ($http, $stateParams, $$log, $$requestUrl, $$toast) {
                    return $http({
                        method: 'GET',
        ...
        .state('hefeiNurseTool', {
            //护士评估
            url: "/:patientId/hefeiNurseTool/:orderId/:toolId/:actionId",
            controller: "hefeiNurseToolStateController",
            templateUrl: "templates/state/hefeiNurseToolState.html",
            resolve: {
                getData: function ($http, $stateParams, $$log, $$requestUrl) {
                    return $http({
                        method: 'GET',
                        url: $$requestUrl.getUrl("hefeiNurseToolStateController", { "nurseId": localStorage.globalNurseId, "toolId": $stateParams.toolId}),
                        params: {
                        }
                    }).success(function (response) {
                        if (response.result.success != true) {
                        ...
                        $$log.debug('hefeiNurseToolStateController');
                        $$log.info(response);
                        return response;
                    });
                }
